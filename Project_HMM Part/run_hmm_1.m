function [transition_mat, emission_mat] = run_hmm_1(s_seq, s_s, s_e, x)
...
% obtain HMMESTIMATE
[transition_mat, emission_mat] = hmmtrain(s_seq_ind, s_s,s_e,'maxiterations',1000,'tolerance',1e-3);
